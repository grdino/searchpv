...
(
    p_search text,
    p_expected_entity_type_cd text DEFAULT NULL,
...
(
    ...
    matched_variant_nm text,
    matched_variant_type_cd text,
    matched_language_cd text,

    match_method text,
    confidence_nb numeric,

    parent_entity_ky bigint,
    parent_entity_type_cd text,
    parent_canonical_nm text,
