    CREATE OR REPLACE VIEW rpt.pending_listing AS
    ...
    WHERE s.stts_cd = 'P'::text;;


    drop view if exists pubic.pending_listing;

    create or replace view public.pending_listing as
    select *
    from rpt.pending_listing;