  ...
  if (error || developmentError) {
    return (
      <main className="min-h-screen p-8">
        ...
        <pre className="mt-4 text-sm">{error?.message ?? developmentError?.message}</pre>
      </main>
    );
  }
                      ...
                      <tbody>
                        {developmentRows.map((development) => (
                          ...
                          >
                            ...
                            <TdRight>{development.active_count ?? 0}</TdRight>
                            <TdRight>{development.pending_count ?? 0}</TdRight>
                            <TdRight>{development.sales_12mo ?? 0}</TdRight>
                            <TdRight>
